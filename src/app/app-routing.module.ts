...
import { PosHelpComponent } from './components/pos-help/pos-help.component';
import { PosCashierComponent } from './components/pos-cashier/pos-cashier.component';
import { BasePosComponent } from './Layout/base-pos/base-pos.component';

const routes: Routes = [
  {
    path: '',
    component: BasePosComponent,
    children: [

      // Main Pages

      { path: '', component: HomeScreenComponent, data: { extraParameter: 'posHome', subParam: '' } },
      { path: 'pos/help', component: PosHelpComponent, data: { extraParameter: 'posHome', subParam: 'help' } },
      { path: 'pos/cashier', component: PosCashierComponent, data: { extraParameter: 'posHome', subParam: 'cashier' } },
    ]
  },
  {
    path: 'demo',
    ...
    children: [
      ...
      // { path: 'pos/home', component: HomeScreenComponent, data: { extraParameter: 'pos' } },
      // { path: 'pos/help', component: PosHelpComponent, data: { extraParameter: 'pos' } },
      // { path: 'pos/cashier', component: PosCashierComponent, data: { extraParameter: 'pos' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'pages/reset-password-boxed', component: ResetPasswordComponent, data: { extraParameter: '' } },
    ]
  },
